...
const ALL_CONNECTORS = [
  ...
  { id: 'pimeyes', label: 'PimEyes', tier: 'osint', requiresKey: null, search: lazySearch('./pimeyes.js') },
  { id: 'libraries-io', label: 'Libraries.io', tier: 'osint', requiresKey: null, search: lazySearch('./librariesIo.js') },
  { id: 'wolfram-alpha', label: 'Wolfram Alpha', tier: 'osint', requiresKey: null, search: lazySearch('./wolframAlpha.js') },
  { id: 'netlas', label: 'Netlas', tier: 'osint', requiresKey: null, search: lazySearch('./netlas.js') },
  ...
  { id: 'teismai-lt', label: 'Lithuanian Courts', tier: 'regional', requiresKey: null, search: lazySearch('./teismaiLt.js') },
  { id: 'e-teismas-lt', label: 'Lithuanian E-Court', tier: 'regional', requiresKey: null, search: lazySearch('./eTeismasLt.js') },
  { id: 'liteko-lt', label: 'LITEKO Court Decisions', tier: 'regional', requiresKey: null, search: lazySearch('./litekoLt.js') },
  { id: 'lrs-lt', label: 'Lithuanian Parliament', tier: 'regional', requiresKey: null, search: lazySearch('./lrsLt.js') },
  { id: 'infolex-lt', label: 'Infolex Legal', tier: 'regional', requiresKey: null, search: lazySearch('./infolexLt.js') },
  { id: 'rekvizitai-lt', label: 'Rekvizitai Company Search', tier: 'regional', requiresKey: null, search: lazySearch('./rekvizitaiLt.js') },
  { id: 'registru-centras-lt', label: 'Centre of Registers Lithuania', tier: 'regional', requiresKey: null, search: lazySearch('./registruCentrasLt.js') },
  { id: 'vmi-lt', label: 'Lithuanian Tax Inspectorate', tier: 'regional', requiresKey: null, search: lazySearch('./vmiLt.js') },
  { id: 'cpo-lt', label: 'CPO Lithuania', tier: 'regional', requiresKey: null, search: lazySearch('./cpoLt.js') },
  { id: 'cvpp-lt', label: 'CVPP Public Procurement', tier: 'regional', requiresKey: null, search: lazySearch('./cvppLt.js') },
  { id: 'lb-lt', label: 'Bank of Lithuania', tier: 'regional', requiresKey: null, search: lazySearch('./lbLt.js') },
  { id: 'fntt-lt', label: 'FNTT Lithuania', tier: 'regional', requiresKey: null, search: lazySearch('./fnttLt.js') },
  { id: 'lrv-open-data-lt', label: 'Lithuanian Open Data', tier: 'regional', requiresKey: null, search: lazySearch('./lrvOpenDataLt.js') },
  { id: 'muitine-lt', label: 'Lithuanian Customs', tier: 'regional', requiresKey: null, search: lazySearch('./muitineLt.js') },
  { id: 'e-tar-lt', label: 'Lithuanian Legal Acts Register', tier: 'regional', requiresKey: null, search: lazySearch('./eTarLt.js') },
  ...
  { id: 'phoenix-open-data', label: 'Phoenix Open Data', tier: 'regional', requiresKey: null, search: lazySearch('./phoenixOpenData.js') },
  { id: 'phoenix-public-records', label: 'Phoenix Public Records', tier: 'regional', requiresKey: null, search: lazySearch('./phoenixPublicRecords.js') },
  { id: 'az-geo', label: 'AZ Geospatial Data', tier: 'regional', requiresKey: null, search: lazySearch('./azGeo.js') },
  { id: 'azdhs-gis', label: 'AZ Health Services GIS', tier: 'regional', requiresKey: null, search: lazySearch('./azdhsGis.js') },
  { id: 'phoenix-chamber', label: 'Phoenix Chamber', tier: 'regional', requiresKey: null, search: lazySearch('./phoenixChamber.js') },
  { id: 'chandler-chamber', label: 'Chandler Chamber', tier: 'regional', requiresKey: null, search: lazySearch('./chandlerChamber.js') },
  { id: 'just-go-az', label: 'Just Go Arizona', tier: 'regional', requiresKey: null, search: lazySearch('./justGoAz.js') },
  { id: 'visit-arizona', label: 'Visit Arizona', tier: 'regional', requiresKey: null, search: lazySearch('./visitArizona.js') },
  { id: 'azsos-trade-names', label: 'AZ Secretary of State Trade Names', tier: 'regional', requiresKey: null, search: lazySearch('./azsosTradeNames.js') },
  { id: 'azcc-business', label: 'AZ Corporation Commission', tier: 'regional', requiresKey: null, search: lazySearch('./azccBusiness.js') },
  { id: 'az-league-jobs', label: 'AZ League Jobs', tier: 'regional', requiresKey: null, search: lazySearch('./azLeagueJobs.js') },
  { id: 'phx-soul', label: 'PHXSoul Business Directory', tier: 'regional', requiresKey: null, search: lazySearch('./phxSoul.js') },
  { id: 'az-job-connection', label: 'AZ Job Connection', tier: 'regional', requiresKey: null, search: lazySearch('./azJobConnection.js') },
  { id: 'arizona-at-work', label: 'Arizona@Work', tier: 'regional', requiresKey: null, search: lazySearch('./arizonaAtWork.js') },
  { id: 'des-az-jobs', label: 'AZ DES Employment', tier: 'regional', requiresKey: null, search: lazySearch('./desAzJobs.js') },
  { id: 'az-corrections', label: 'AZ Corrections Inmate Search', tier: 'regional', requiresKey: null, search: lazySearch('./azCorrections.js') },
  { id: 'azdps', label: 'AZ Dept of Public Safety', tier: 'regional', requiresKey: null, search: lazySearch('./azdps.js') },
  { id: 'icrime-watch', label: 'iCrimeWatch AZ', tier: 'regional', requiresKey: null, search: lazySearch('./iCrimeWatch.js') },
  { id: 'nsopw', label: 'National Sex Offender Registry', tier: 'regional', requiresKey: null, search: lazySearch('./nsopw.js') },
  { id: 'az-archives-online', label: 'AZ Archives Online', tier: 'regional', requiresKey: null, search: lazySearch('./azArchivesOnline.js') },
  { id: 'az-library', label: 'AZ State Library', tier: 'regional', requiresKey: null, search: lazySearch('./azLibrary.js') },
  ...
  { id: 'leigh-surrey-history', label: 'Leigh & District History', tier: 'regional', requiresKey: null, search: lazySearch('./leighSurreyHistory.js') },
  { id: 'huncote-history', label: 'Huncote Parish History', tier: 'regional', requiresKey: null, search: lazySearch('./huncoteHistory.js') },
  { id: 'appleby-magna-history', label: 'Appleby Magna History', tier: 'regional', requiresKey: null, search: lazySearch('./applebyMagnaHistory.js') },
  { id: 'flitwick-history', label: 'History of Flitwick', tier: 'regional', requiresKey: null, search: lazySearch('./flitwickHistory.js') },
  { id: 'bblhs', label: 'Beds & Bucks Local History Society', tier: 'regional', requiresKey: null, search: lazySearch('./bblhs.js') },
  { id: 'cemetery-scribes', label: 'Cemetery Scribes', tier: 'regional', requiresKey: null, search: lazySearch('./cemeteryScribes.js') },
  { id: 'community-archives', label: 'Community Archives', tier: 'regional', requiresKey: null, search: lazySearch('./communityArchives.js') },
  { id: 'the-old-school', label: 'The Old School Archive', tier: 'regional', requiresKey: null, search: lazySearch('./theOldSchool.js') },
  { id: 'local-history-links', label: 'Local History Links', tier: 'regional', requiresKey: null, search: lazySearch('./localHistoryLinks.js') },
  { id: 'ukbmd-parish', label: 'UKBMD Parish Records', tier: 'regional', requiresKey: null, search: lazySearch('./ukbmdParish.js') },
  { id: 'historic-england', label: 'Historic England', tier: 'regional', requiresKey: null, search: lazySearch('./historicEngland.js') },
  { id: 'exploring-surreys-past', label: "Exploring Surrey's Past", tier: 'regional', requiresKey: null, search: lazySearch('./exploringSurreysPast.js') },
  { id: 'old-maps-online', label: 'Old Maps Online', tier: 'regional', requiresKey: null, search: lazySearch('./oldMapsOnline.js') },

  // ── REGIONAL – Bolivia ─────────────────────────────────────────────────────
  { id: 'fiva-bo', label: 'FIVA Bolivia Tax', tier: 'regional', requiresKey: null, search: lazySearch('./fivaBo.js') },
  { id: 'siat-bo', label: 'SIAT Bolivia Tax Info', tier: 'regional', requiresKey: null, search: lazySearch('./siatBo.js') },
  { id: 'senapi-bo', label: 'SENAPI Bolivia IP', tier: 'regional', requiresKey: null, search: lazySearch('./senapiBo.js') },
  { id: 'autoridad-minera-bo', label: 'Bolivia Mining Authority', tier: 'regional', requiresKey: null, search: lazySearch('./autoridadMineraBo.js') },
  { id: 'gaceta-santa-cruz-bo', label: 'Santa Cruz Official Gazette', tier: 'regional', requiresKey: null, search: lazySearch('./gacetaSantaCruzBo.js') },
  { id: 'bcb-bo', label: 'Central Bank of Bolivia', tier: 'regional', requiresKey: null, search: lazySearch('./bcbBo.js') },
  { id: 'sicoes-bo', label: 'SICOES Bolivia Procurement', tier: 'regional', requiresKey: null, search: lazySearch('./sicoesBo.js') },

  // ── REGIONAL – Camden ──────────────────────────────────────────────────────
  { id: 'open-camden', label: 'Camden Open Data', tier: 'regional', requiresKey: null, search: lazySearch('./openCamden.js') },
